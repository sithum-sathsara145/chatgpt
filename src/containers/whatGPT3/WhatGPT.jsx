...
export default function WhatGPT() {
  ...
  const chatbots =
    "We so opinion friends me message as delight. Whole front do of plate heard oh oughWe so opinion friends me message as delight. Whole front do of plate heard oh ought. ";
  const knowledge =
